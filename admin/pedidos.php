...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pedidos Loja eSC
        <small>Área de administração de pedidos realizados na loja</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
		<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Pedidos em Aberto</h3>
					...
					<?php
						$pedidos = mysqli_query($conexao, "SELECT * FROM pedido WHERE data_entrega is null ORDER BY data_pedido");
					  	while($pedido = mysqli_fetch_array($pedidos)){
                            $comprador = mysqli_fetch_array(mysqli_query($conexao, "SELECT nome, sobrenome FROM jogador WHERE codigo = ".$pedido['cod_jogador'].""));
