            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <table cellspacing="0" cellpadding="0" id="tabelaLobbys" class="centralizar">
                        ...
                        <?php
                        $torneios = mysqli_query($conexao, "SELECT * FROM campeonato WHERE cod_organizacao = ".$organizacao['codigo']." AND inicio_inscricao > '$datahora' AND status = 0 ORDER BY inicio ASC");
