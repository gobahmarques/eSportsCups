...
<html>
    <head>
        ...
        <title>Torneios Em Andamento - <?php echo $organizacao['nome']; ?> | e-Sports Cups</title>
    </head>
    <body>
        <?php 
            include "../header.php";
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <table cellspacing="0" cellpadding="0" id="tabelaLobbys" class="centralizar">
                        ...
                        <?php
                        $torneios = mysqli_query($conexao, "SELECT * FROM campeonato WHERE cod_organizacao = ".$organizacao['codigo']." AND status = 1 ORDER BY inicio ASC");
