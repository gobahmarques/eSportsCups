<div class="menuOponente">
	<div class="barraCentral centralizar">		
		<?php
				if($usuario['codigo'] == $sementeUm['codigo']){ // JOGADOR É O PLAYER 1		
					?>
					<div class="chats">
						<ul class="abasChat">
							<li class="chatGeral" onClick="abaChat('1');">OPONENTE</li>
							<?php
						...
						if($partida['datahora'] != NULL){
							...
							?>
								<div class="alerta">
									...
									<input type="button" value="ESTOU PRONTO" class="botaoPqLaranja" onClick="realizarCheckin(<?php echo $partida['codigo'].",".$sementeUm['codigo']; ?>)"><br><br>
						...
						if(mysqli_num_rows($checkin) != 0){ // OPONENTE JÁ ESTÁ PRONTO
							if($campeonato['qtd_ban'] != 0){ // É OBRIGATORIO FAZER BAN
								if($sementeUm['bans'] == NULL){ // MOSTRAR HERÓIS PARA BAN
									...
									echo "<form action='draft-enviar.php' method='post' onSubmit='return validar();'>";
									...
									?>
										...
										<?php
										 ...
										 ?>
											...
											<input type="button" value="ENVIAR NOVO PLACAR" class="botaoPqLaranja" onClick="reenviarPlacar(<?php echo $sementeUm['cod_semente'].", ".$partida['codigo']; ?>)">							
											<?php
										 }
										?>																		
										</div>
							...
							if($partida['datahora'] != NULL){
								...
								?>
									<div class="alerta">
										...
										<input type="button" value="RECEBER W.O." class="botaoPqLaranja" onClick="receberWo(<?php echo $partida['codigo']; ?>,<?php echo $sementeUm['cod_semente']; ?>);">						
									</div>
								<?php	
				...
				}elseif($usuario['codigo'] == $sementeDois['codigo']){ // JOGADOR É O PLAYER 2
					?>
					<div class="chats">
						<ul class="abasChat">
							<li class="chatGeral" onClick="abaChat('1');">OPONENTE</li>
