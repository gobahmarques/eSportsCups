<?php
	...
	$inicioCamp = date("Y-m-d H:i:s", strtotime("+11days", strtotime($inicio)));
	...
	$inicioCamp = date("Y-m-d H:i:s", strtotime("+18days", strtotime($inicio)));
	$fim = date("Y-m-d H:i:s", strtotime("+4hours 59minutes", strtotime($inicioCamp)));
	$inicioInscricao = date("Y-m-d H:i:s", strtotime("-7days", strtotime($inicioCamp)));
	$fimInscricao = date("Y-m-d H:i:s", strtotime("-30minutes", strtotime($inicioCamp)));
	mysqli_query($conexao, "
	...
	$inicioCamp = date("Y-m-d H:i:s", strtotime("+25days", strtotime($inicio)));
	$fim = date("Y-m-d H:i:s", strtotime("+4hours 59minutes", strtotime($inicioCamp)));
	$inicioInscricao = date("Y-m-d H:i:s", strtotime("-7days", strtotime($inicioCamp)));
	$fimInscricao = date("Y-m-d H:i:s", strtotime("-30minutes", strtotime($inicioCamp)));
	mysqli_query($conexao, "
	...
	$inicioCamp = date("Y-m-d H:i:s", strtotime("+32days", strtotime($inicio)));
	$fim = date("Y-m-d H:i:s", strtotime("+4hours 59minutes", strtotime($inicioCamp)));
	$inicioInscricao = date("Y-m-d H:i:s", strtotime("-7days", strtotime($inicioCamp)));
	$fimInscricao = date("Y-m-d H:i:s", strtotime("-30minutes", strtotime($inicioCamp)));
	mysqli_query($conexao, "
